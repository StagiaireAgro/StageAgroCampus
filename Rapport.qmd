...
- (1)On récupère les données `nb_tres_freq` qui sont le nombre de lieu d'achat très fréquenté par individu et 
...
ggplot(data = df_nb_tres_freq, mapping = aes(x = nb_tres_freq, y = Freq)) +
