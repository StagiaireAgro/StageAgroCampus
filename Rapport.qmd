...
### 23. Quelles motivations à fréquenter le marché
...
table(data$Q230, data$Q1, useNA = "ifany") # Selon le genre
table(data$Q230, data$Q2, useNA = "ifany") # selon l'âge
table(data$Q230, data$Q3, useNA = "ifany") # Selon la CSP
table(data$Q230, data$Q8, useNA = "ifany") # selon le budget alimentaire
table(data$Q230, data$Q240, useNA = "ifany") # selon le niveau de diplôme
table(data$Q230, data$Q236, useNA = "ifany") # selon le nombre d'enfants
```
