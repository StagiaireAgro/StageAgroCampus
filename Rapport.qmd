...
tableau_croise_generalise(df, "Q1", questions)      # selon le genre
tableau_croise_generalise(df, "Q3", questions)        # selon la CSP
tableau_croise_generalise(df, "Q8", questions)         # selon le budget alimentaire
tableau_croise_generalise(df, "Q240", questions)    # selon le niveau de diplôme
tableau_croise_generalise(df, "Q236", questions) # selon le nombre d'enfants
```
