...
6. On calcule le pourcentage des individus qui achètent très régulièrement en circuit court en calculant et le nombre d'individus sur le nombre d'individus total que l'on multipli par 100 avec `sum()` et `nrow()`
...
6. On calcule le pourcentage des individus qui achètent régulièrement en circuit court en calculant et le nombre d'individus sur le nombre d'individus total que l'on multipli par 100 avec `sum()` et `nrow()`
