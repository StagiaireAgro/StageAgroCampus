...
data_moy_indicat_purete <-
  data.frame("Moyenne",NA,round(mean(table_indica_purete_asperge$nb_levels_llm)),
...
matrice_confusion_prompt_60$Negatifs[[2]] <-table_indica_purete_asperge$nb_levels_initial[10] -  table_indica_purete_asperge$nb_levels_commun[[10]] - table_indica_purete_asperge$nb_prod_transfo_pas_trouves_llm[[10]]
...
# Export de la matrice de confusion LLM
