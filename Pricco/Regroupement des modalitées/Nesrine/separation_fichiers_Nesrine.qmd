...
ATTENTION !! Revoir la liste des onthologies pour la première fonction car oublie de certaines variétés de nom de produits comme tomates cerises pour la catégorie tomate.

ATTENTION !! Exclure la table jus de pomme 

Se baser sur le fichier des onthologies des fournisseurs. Puis, imaginer des grandes familles
génériques comme compte, confiture. Attention, ne pas oublier des cas "plus spécifiques" mais non négligeable dans certaines tables comme pruneau(x) dans la table prune à retirer ou toutes les variétés de chou (pommé etc.) qui n'ont pas leur place dans les tables.
...
```{r}
liste_produits_transformes <- c("beurre","fromage","yaourt", "crème", "dessert", "jus", "smoothie", "soupe", "chou pomme", "pruneau","confiture","nectar", "tarte", "pain", "amande", "potage","caviar","riste", "brownie", "chips", "axoa", "pot au feu", "bourguignon", "brochette", "bolognaise", "carbonade", "carpaccio", "chou coeur", "veau", "burger", "lasagne",
"plat", "savon", "saute", "sauce", "terrine", "blette", "rape","limoune", "citron", "petits pois", "tartinade", "biscuit", "veloute", "vaisselle", "tarocco", "marines", "pickle", "provencale", "epice", "curry", "piment", "vegetal","soupe","guimauve","lavande","menthe","sirop","sorbet","coulis", "betterave", "cassis","framboise","groseille", "mure","myrtille","rhubarbe","cidre","coing","gingembre","melisse", "orange","ortie", "cr�me",
...
## 4) Développement de la fonction pour supprimer les 
...
# On ajoute la table dui jus de pomme dans notre liste de résultat
liste_data_propre[["jus de pomme"]] <- data_jus_de_pomme

# On fusionne la table des produits transformés avec la table autre
data_pas_ok <- rbind(data_pas_ok,data_produits_transformes)
