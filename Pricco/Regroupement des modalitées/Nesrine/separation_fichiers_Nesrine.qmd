...
data_socleo_2021 <- vroom("data/la ruche qui dit oui/toutsocleo_2021.csv")
...
data_coop_circuit_2024 <- vroom("data/coop circuit/par annee/2024.csv")

########################## la ruche qui dit oui ########################## 

data_ruche_oui_2021_part_1 <- vroom("data/la ruche qui dit oui/historique_2021part1.csv")
data_ruche_oui_2021_part_2 <- vroom("data/la ruche qui dit oui/historique_2021part2.csv")
...
data_ruche_oui_2024 <- vroom("data/la ruche qui dit oui/historique_2024.csv")
```
...
### b) Version 1 : Liste contenant toutes les déclinaisons possibles pour chaque nom de produit
...
### c) Version 2 : Liste contenant toutes les déclinaisons possibles pour chaque nom de produit
...
## 6) Suppression des produits transformés pour les pêches
...
## 7) Création d'une liste pour y placer le data_jus_de_pomme
...
## 8) Création d'une liste pour y placer le data_peche
...
## 9) Création d'une liste pour y placer le data_nectarine
...
## 10) Retirer data_jus_de_pomme, data_nectarine et data_peche de la liste de résultat
...
## 11) Application de la fonction sur tous les jeux de données
...
data_pas_ok <- 
  rbind(data_pas_ok,data_produits_transformes,data_produits_transformes_jus_pomme,
