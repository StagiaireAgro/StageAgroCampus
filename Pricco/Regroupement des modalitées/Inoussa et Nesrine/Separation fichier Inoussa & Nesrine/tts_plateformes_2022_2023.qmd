...
# VI) Fusion de tous les fichiers de cagette
...
liste_produits_alimentaires <- c(
  ...
  "Haricot vert","Kiwi","Laitue","Melon","Nectarine","Oignon","Pore","Poireau","Poivron",
...
# VII) Fusion de tous les fichiers issus de toutes les plateformes

```{r}
# On supprime la colonne name_clean de data_ok2

data_ok2 <- data_ok2 |> select(-c("name_clean"))

# On fusionne toutes les tables de cagette en une seule
datsets_tts_plateformes <- rbind(liste_finale_datasets_cagette,data_ok2)
View(datsets_tts_plateformes)
