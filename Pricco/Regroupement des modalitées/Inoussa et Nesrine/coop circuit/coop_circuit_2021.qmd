...
liste_declinai_noms_produits <- list(
  "abricot" = abricot_declinaison,
  "banane" = banane_declinaison,
  "cerise" = cerise_declinaison,
  "clementine" = clementine_declinaison,
  "fraise" = fraise_declinaison,
  "kiwi" = kiwi_declinaison,
  "nectarine" = nectarine_declinaison,
  "noix" = noix_declinaison,
  "peche" = peche_declinaison,
  "poire" = poire_declinaison,
  "pomme de terre" = pdt_declinaison,
  "jus de pomme" = jus_pomme_declinaison,
  "pomme" = pomme_declinaison,
  "prune" = prune_declinaison,
  "raisin" = raisin_declinaison,
  "carotte" = carotte_declinaison,
  "celeri branche" = celeri_branche_declinaison,
  "chou fleur" = chou_fleur_declinaison,
  "concombre" = concombre_declinaison,
  "courgette" = courgette_declinaison,
  "endive" = endive_declinaison,
  "haricot vert" = haricot_vert_declinaison,
  "laitue" = laitue_declinaison,
  "melon" = melon_declinaison,
  "oignon" = oignon_declinaison,
  "poireau" = poireau_declinaison,
  "poivron" = poivron_declinaison,
  "potiron" = potiron_declinaison,
  "tomate" = tomate_declinaison,
  "lait" = lait_declinaison,
  "oeuf" = oeuf_declinaison,
  "boeuf" = boeuf_declinaison,
  "porc" = porc_declinaison,
  "poulet" = poulet_declinaison,
  "lentille" = lentille_declinaison
  )
# On va ordonner la liste saisie manuellement en fonction de la taille des noms du produit
## Comptons la taille de chaque nom de produit dans la liste
lengths <- nchar(gsub(" ", "", names(liste_declinai_noms_produits)))
## Ordonnons maintenant de manière decroissante
liste_declinai_noms_produits <- liste_declinai_noms_produits[order(lengths, decreasing = TRUE)]
```
...
final_declinaisons <- trouver_declinaisons_nom_produit(
    dataset = data_coop_circuit_2021,
    col_produit = "name",
...
```{r,message=FALSE,warning=FALSE}
final_declinaisons$laitue <- c(final_declinaisons$laitue, "laitue pomme", "laitue pommee", " Laitue pommée")
