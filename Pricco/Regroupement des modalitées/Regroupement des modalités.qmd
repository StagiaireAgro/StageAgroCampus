...
liste_socleo_sans_autres_2021 <- liste_resultats_socleo_2021[names(liste_resultats_socleo_2021) != "socleo_autres"]
...
verif_socleo_2021 <- recherche_termes(liste_socleo_sans_autres_2021,liste_mots_cles)

# Nombre de jeux de données présent dans la liste de vérification 
length(verif_socleo_2021)

############################## 2022

# On retire le df_autres 
liste_socleo_sans_autres_2022 <- liste_resultats_socleo_2022[names(liste_resultats_socleo_2022) != "socleo_autres"]
...
# On Teste la fonction
verif_socleo_2022 <- recherche_termes(liste_socleo_sans_autres_2022,liste_mots_cles)

############################## 2023

# On retire le df_autres 
liste_socleo_sans_autres_2023 <- liste_resultats_socleo_2023[names(liste_resultats_socleo_2023) != "socleo _autres"]
...
# On Teste la fonction
verif_socleo_2023 <- recherche_termes(liste_socleo_sans_autres_2023,liste_mots_cles)

############################## 2024

# On retire le df_autres 
liste_socleo_sans_autres_2024 <- liste_resultats_socleo_2024[names(liste_resultats_socleo_2024) != "socleo _autres"]
...
# On Teste la fonction
verif_socleo_2024 <- recherche_termes(liste_socleo_sans_autres_2024,liste_mots_cles)
...
# On retire le df_autres 
liste_coop_circuit_sans_autres_2021 <- liste_resultats_coop_circuit_2021[names(liste_resultats_coop_circuit_2021) != "coop_circuit _autres"]
...
# On Teste la fonction
verif_coop_circuit_2021 <- recherche_termes(liste_coop_circuit_sans_autres_2021,liste_mots_cles)

############################## 2022

# On retire le df_autres 
liste_coop_circuit_sans_autres_2022 <- liste_resultats_coop_circuit_2022[names(liste_resultats_coop_circuit_2022) != "coop_circuit _autres"]
...
# On Teste la fonction
verif_coop_circuit_2022 <- recherche_termes(liste_coop_circuit_sans_autres_2022,liste_mots_cles)

############################## 2023

# On retire le df_autres 
liste_coop_circuit_sans_autres_2023 <- liste_resultats_coop_circuit_2023[names(liste_resultats_coop_circuit_2023) != "coop_circuit _autres"]
...
# On Teste la fonction
verif_coop_circuit_2023 <- recherche_termes(liste_coop_circuit_sans_autres_2023,liste_mots_cles)

############################## 2024

# On retire le df_autres 
liste_coop_circuit_sans_autres_2024 <- liste_resultats_coop_circuit_2024[names(liste_resultats_coop_circuit_2024) != "coop_circuit _autres"]
...
# On Teste la fonction
verif_coop_circuit_2024 <- recherche_termes(liste_coop_circuit_sans_autres_2024,liste_mots_cles)
