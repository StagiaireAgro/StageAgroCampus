...
nngroup_products <- function(data, ls_word){
      ...
      for(un_nom_produit in levels_name_produit){
        for(mots_cle in ls_word[ls_word!=word]){
          ...
          if(grepl(mots_cle, un_nom_produit)){
            ...
            i <- i+1
            if(i==40){
              print(multiple_noms_produits_temp)
              break
            }
          }
        }
...
socleo_2021 <- nngroup_products(data_socleo_2021, fruits_triee)
...
liste_resultats_socleo_2021 <- ngroup_products(data_socleo_2021,fruits_triee)
liste_resultats_socleo_2022 <- ngroup_products(data_socleo_2022,fruits_triee)
liste_resultats_socleo_2023 <- ngroup_products(data_socleo_2023,fruits_triee)
liste_resultats_socleo_2024 <- ngroup_products(data_socleo_2024,fruits_triee)

########################## coop circuit ########################## 

liste_resultats_coop_circuit_2021 <- ngroup_products(data_coop_circuit_2021,fruits_triee)
liste_resultats_coop_circuit_2022 <- ngroup_products(data_coop_circuit_2022,fruits_triee)
liste_resultats_coop_circuit_2023 <- ngroup_products(data_coop_circuit_2023,fruits_triee)
liste_resultats_coop_circuit_2024 <- ngroup_products(data_coop_circuit_2024,fruits_triee)
...
# On teste 
liste_resultats_ruche_oui_2021_part_1 <- ngroup_products(data_ruche_oui_2021_part_1,fruits_triee)

 # On renomme la variable du nom de produit pour que la fonction marche
names(data_ruche_oui_2021_part_2)[8] <- c("name")

# On teste 
liste_resultats_ruche_oui_2021_part_2 <- ngroup_products(data_ruche_oui_2021_part_2,fruits_triee)

 # On renomme la variable du nom de produit pour que la fonction marche
names(data_ruche_oui_2022)[8] <- c("name")

# On teste 
liste_resultats_ruche_oui_2022 <- ngroup_products(data_ruche_oui_2022,fruits_triee)

 # On renomme la variable du nom de produit pour que la fonction marche
names(data_ruche_oui_2023)[8] <- c("name")

# On teste 
liste_resultats_ruche_oui_2023 <- ngroup_products(data_ruche_oui_2023,fruits_triee)

 # On renomme la variable du nom de produit pour que la fonction marche
names(data_ruche_oui_2024)[8] <- c("name")

# On teste 
liste_resultats_ruche_oui_2024 <- ngroup_products(data_ruche_oui_2024,fruits_triee)
